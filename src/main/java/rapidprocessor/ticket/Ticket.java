...
public class Ticket {
	 ...
	 * @param price
	*/
	public Ticket(String eventTitle, String sellerName, Integer quantityAvailable, BigDecimal price) {
	 ...
	 * EEEEEEEEEEEEEEEEEEE_SSSSSSSSSSSSS_TTT_PPPPPP Where EEEEEEEEEEEEEEEEEEE is the
	 * event name SSSSSSSSSSSSSS is the seller’s username TTT Is the number of
	 * tickets for sale PPPPPP is the price per ticket. _ is a space
	 * 
